...
#		and prior on piGSI as 1/N - not sharing information across strata
...
# data = dataList[[1]]
	...
	for(s in 1:length(input)){
		...
		### but leave GSI groups with no observed unassigned fish as 0
...
save(sr_mean, sr_upper, sr_lower, srSD_mean, srSD_upper, srSD_lower, srRec, trueComp, convergeMLE, srMLE_mean,
	  srMLE_lower, srMLE_upper, file = "./rdaOutputs/large_sampRateSimsOutput_sym1divN_all_gsiSep.rda")

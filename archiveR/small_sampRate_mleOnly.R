...
# this is sample rate of SMALL scenario with just MLE
...
###################
## note that this uses forking through the parallel package, so it will not work on Windows systems unless you
## set countCores <- 1
###################
...
save(sr_mean, sr_upper, sr_lower, srSD_mean, srSD_upper, srSD_lower, srRec, trueComp, convergeMLE, srMLE_mean,
	  srMLE_lower, srMLE_upper, file = "./rdaOutputs/small_sampRate_mle.rda")
